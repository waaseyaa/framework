...
final class RevisionLifecycleIntegrationTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->repo = \Waaseyaa\EntityStorage\Testing\V2EntityRepositoryFactory::create($entityType, $driver, $dispatcher, $revisionDriver, $this->db);
    }
    ...
    public function non_revisionable_entity_type_ignores_revision_logic(): void
    {
        ...
        $driver = new SqlStorageDriver($resolver);
        $dispatcher = new EventDispatcher();
        $repo = \Waaseyaa\EntityStorage\Testing\V2EntityRepositoryFactory::create($entityType, $driver, $dispatcher);
