...
return [
    'entries' => [
        ['fqcn' => 'Waaseyaa\\Deployer\\RuntimeState\\RuntimeTablePolicy', 'disposition' => 'public', 'purpose' => 'Versioned ownership policy for framework SQLite artifact and serving-host runtime tables'],
    ],
];
