...
final readonly class ContentTypeDescriptor
{
     ...
     * @param HtmlSanitizerConfig $sanitizerConfig Explicit editorial allowlist applied
     *                            to every {@see FieldSpec::$html} field before persistence.
    ...
    public function __construct(
        ...
        public HtmlSanitizerConfig $sanitizerConfig,
