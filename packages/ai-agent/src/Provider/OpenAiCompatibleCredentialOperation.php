...
final class OpenAiCompatibleCredentialOperation implements SecretConsumerInterface
{
    public const string PURPOSE = 'waaseyaa.ai.openai-chat.v1';
    ...
    {
        return 'waaseyaa.ai-agent.openai-chat-request.v1';
    }
