...
/** Closed session and authorization-claims bootstrap primitive. @api */
final readonly class SessionBootstrapReader
{
    ...
    {
        return $this->reader->readMany($capability, $boundary, $account, $fields, CapabilityReason::SessionBootstrap);
    }
}
