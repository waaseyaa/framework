...
#[CoversClass(WindsurfClientTransformer::class)]
final class WindsurfClientTransformerTest extends TestCase
{
    #[Test]
    public function returnsCorrectClientId(): void
    {
        self::assertSame('windsurf', (new WindsurfClientTransformer())->clientId());
    }

    #[Test]
    public function producesExactlyOneTargetFile(): void
    {
        $files = (new WindsurfClientTransformer())->targetFiles(InstallSkillFixtures::all());
        self::assertCount(1, $files);
        self::assertSame('.windsurfrules', $files[0]->path);
    }
    ...
    {
        $content = (new WindsurfClientTransformer())->targetFiles(InstallSkillFixtures::all())[0]->content;
    ...
    {
        $files = (new WindsurfClientTransformer())->targetFiles([]);
        self::assertCount(1, $files);
