 ...
 * instead of a hardcoded `targetPath()` override changed not one byte of what
 * those clients receive on disk. Per-skill clients (`claude`, `codex`) changed
 * intentionally in #2660 Part B and are covered by their own transformer tests.
 *
