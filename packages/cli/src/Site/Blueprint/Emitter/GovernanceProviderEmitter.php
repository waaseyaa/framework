 ...
 *
 * Emits nothing when the blueprint declares zero roles AND zero workflows
 * (e.g. `minimal.yaml`).
 *
 * @api
 */
final class GovernanceProviderEmitter implements BlueprintArtifactEmitterInterface
{
    ...
    public function emit(ApplicationBlueprint $blueprint, SiteManifest $manifest): BlueprintEmission
    {
        ...
        if ($blueprint->roles === [] && $blueprint->workflows === []) {
        ...
        $content = $this->renderProvider($roles, $workflows);
    ...
    private function renderProvider(array $roles, array $workflows): string
    {
        ...
        return <<<PHP
            ...
            {$workflowUses}use Waaseyaa\\Foundation\\ServiceProvider\\Capability\\ProvidesRolesInterface;
             ...
             * Do not edit by hand.
             */
            final class ApplicationBlueprintGovernanceServiceProvider extends ServiceProvider implements ProvidesRolesInterface
            {
