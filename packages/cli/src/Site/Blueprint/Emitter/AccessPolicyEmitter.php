...
{
    private const string BLUEPRINT_GENERATOR_COMMENT = 'Generated by Waaseyaa\\CLI\\Site\\Blueprint\\ApplicationBlueprintCompiler.';

    private const string MANUAL_SCAFFOLD_GENERATOR_COMMENT = 'Generated by Waaseyaa\\CLI\\make:policy (stdout scaffold — review before registering).';
    ...
    public function renderPolicyClass(string $entityId, ?string $ownerField, string $className, array $policies, bool $workflowBound, ?string $entityClassFqcn = null): string
    {
        ...
        return $this->renderPolicy($entity, $className, $policies, $workflowBound, $entityClassFqcn, fromManualScaffold: true);
    }
     ...
     */
    private function renderPolicy(BlueprintEntity $entity, string $className, array $policies, bool $workflowBound, ?string $entityClassFqcn = null, bool $fromManualScaffold = false): string
    {
        $entityId = $entity->id;
        ...
        $generatorComment = $fromManualScaffold
            ? self::MANUAL_SCAFFOLD_GENERATOR_COMMENT
            : self::BLUEPRINT_GENERATOR_COMMENT;
        $doNotEditLine = $fromManualScaffold
            ? 'Does not imply blueprint compilation or automatic registration.'
            : 'Do not edit by hand.';
        ...
        return <<<PHP
            ...
            /**
             * {$generatorComment}
             * {$doNotEditLine} Open-by-default: every entity-level branch below either
