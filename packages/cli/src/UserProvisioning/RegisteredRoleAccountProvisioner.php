    ...
    public function provision(
        ...
        try {
            $user = $repository->create([
                'name' => $username,
                'mail' => $mail,
                'identity_name_key' => User::canonicalIdentityKey($username),
                'identity_mail_key' => User::canonicalIdentityKey($mail),
                'pass' => $passwordHash,
                'legacy_pass' => null,
            ...
            return new RegisteredRoleProvisioningResult(
                ...
                $roleId,
                $user instanceof EntityInterface ? self::accountId($user) : null,
            );
        ...
        if (!$user instanceof EntityInterface) {
            return new RegisteredRoleProvisioningResult('refused', 'storage_failure', $roleId);
        }
