...
final class SiteDoctorHandlerTest extends TestCase
{
    ...
    private function tester(string $root): CliTester
    {
        ...
        $container = new class($handler) implements ContainerInterface {
            ...
            public function get(string $id): mixed { return $id === SiteDoctorHandler::class ? $this->handler : throw new \RuntimeException('Unexpected service.'); }
            public function has(string $id): bool { return $id === SiteDoctorHandler::class; }
        };
