...
/**
 * Kernel fallback for a durable V2 gateway ledger when no audit provider is installed.
 *
 * The authority is deliberately write-only: callers can reserve and finalize an
 * exact attempt, but cannot obtain the database or mutate an existing ledger row.
 *
 * @internal
 */
