        ...
        return new class ($recorder, $baseRow) implements EntityTypeManagerInterface {
            ...
            public function getRepository(string $entityTypeId): EntityRepositoryInterface
            {
                ...
                return new class ($recorder, $baseRow) implements EntityRepositoryInterface {
                    ...
                    public function find(int|string $id, ?string $langcode = null, bool $fallback = false): ?EntityInterface { return $this->baseRow; }
                    public function loadWorkingCopy(int|string $id): ?EntityInterface { return null; }
