 ...
 */
export function isContractCompatible(serverVersion: string | undefined, clientVersion: string = ADMIN_CONTRACT_VERSION): boolean {
  if (!serverVersion) return true // legacy hosts predate versioning — assume compatible
