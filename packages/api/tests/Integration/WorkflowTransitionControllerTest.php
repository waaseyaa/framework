...
final class WorkflowTransitionControllerTest extends TestCase
{
    ...
    {
        return new AuthorizationPrincipal($id, true, ['authenticated'], $permissions, 'test-' . $id);
    }
...
final class FixtureWorkflowEntityRepository implements EntityRepositoryInterface, AggregateMutationRepositoryInterface
{
    ...
    public function exists(int|string $id): bool { return isset($this->entities[$id]); }
...
final class FixtureWorkflowLookupRepository implements EntityRepositoryInterface
{
    ...
    public function create(array $values = []): EntityInterface { throw new \LogicException('not needed'); }
    public function find(int|string $id, ?string $langcode = null, bool $fallback = false): ?EntityInterface { return $this->workflow; }
    ...
    public function exists(int|string $id): bool { return $this->workflow !== null; }
