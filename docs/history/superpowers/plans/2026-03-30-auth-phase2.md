...
**Design Spec:** `docs/history/superpowers/specs/2026-03-30-auth-phase2-design.md`
...
```bash
gh api repos/waaseyaa/framework/milestones -f title="Auth System — Phase 2: Registration & Verification (P1)" -f description="Registration (admin/open/invite), password reset with mail policy, email verification with configurable gating. Design: docs/history/superpowers/specs/2026-03-30-auth-phase2-design.md"
```
