...
**Spec:** `docs/history/superpowers/specs/2026-03-16-co-development-skill-set-design.md`
...
Record in a scratch file (`docs/history/superpowers/plans/baseline-app-dev.md`):
