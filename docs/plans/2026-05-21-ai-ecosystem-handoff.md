...
> `docs/plans/2026-05-21-ai-ecosystem-beta-tightening.md` (the design doc).
...
gh pr create \
  ...
  --body "M1 WP01. Closes nothing directly; see docs/plans/2026-05-21-ai-ecosystem-beta-tightening.md for the cluster."
...
> `docs/plans/2026-05-21-ai-ecosystem-handoff.md`.
>
...
> `docs/plans/2026-05-21-ai-ecosystem-beta-tightening.md`.
>
