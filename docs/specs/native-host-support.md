...
without case on Windows), and its digest covers the candidate paths and
blobs it installed. Candidate files the export-ignore policy withholds from
the archive and Composer's mirror are recorded as withheld. The Linux
