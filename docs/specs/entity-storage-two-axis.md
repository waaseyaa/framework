<!-- Spec reviewed 2026-07-19 - Sheguiandah gap batch: media's entity-gated download now reads only Protected source_uri through a typed audited capability seam. This does not activate or alter the parked MediaVersion/CAS subsystem or either revision/translation axis described historically below; the canonical read-boundary contract lives in entity-field-read-boundary.md. -->
