...
<!-- Spec reviewed 2026-08-10 - #2327 configured-community principal convergence: FieldReadContextMiddleware preserves explicit route/session scope precedence, then falls back to the authoritative active CommunityContextInterface for fixed-community routes. The resulting immutable principal and community-scoped runtime must agree; an inactive context remains null. -->
