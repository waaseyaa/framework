...
- `packages/ai-agent/src/AnthropicProvider.php` (new)
- `packages/ai-agent/src/MessageRequest.php` (new)
- `packages/ai-agent/src/MessageResponse.php` (new)
...
### #605
- `packages/ai-agent/src/StreamingProviderInterface.php` (new)
- `packages/ai-agent/src/StreamChunk.php` (new)
- `packages/ai-agent/src/AnthropicProvider.php` (modify — implement StreamingProviderInterface)
