...
Immutable candidate fcd4243aa8d98da6d948670262ddd798b8f41381 passed full preflight 41/41, Unit 14,118 / 240,083, Integration 2,311 / 11,736, and Architecture 591 / 32,007, including all clean-archive proofs. Final boundary review found the existing staged verifier omitted runtime migrations, recipes, root configuration and skeleton CI/configuration scripts. A synthetic-root regression failed before widening the inventory. The widened entrypoint guard kills deliberate skeleton CI seam and deployment recipe refusal callers; restored boundary controls pass 6 / 103. This final correction changes verification scope only; publication qualification is repeated on the final head.
