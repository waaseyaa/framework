...
- 2026-06-12T07:23:01Z – claude:fable-5:reviewer:reviewer – shell_pid=26804 – Review passed: constant-time hash_equals full scan verified (no break, (string) cast, fail-closed duck-typed isActive after the scan, blocked===unknown at auth-result level); resolveDatabasePath/absolutize CWD-independent with Windows-aware passthrough and byte-identical unset default; DbInitHandler shares the resolver, health/about display resolved paths; DbPathResolutionTest proves SC-004 (same file, zero sqlite under public/). Gates: phpunit (mcp 137, foundation Bootstrap 38, cli handler tests), phpstan 0 errors, cs-check clean, check-dead-code clean. Baseline 2->1 is a shrink; phpdoc string|int widening matches runtime key coercion. 4 CLI help-snapshot failures are pre-existing (identical at parent 79562e180).
- 2026-06-12T07:39:37Z – claude:fable-5:reviewer:reviewer – shell_pid=26804 – Done override: Mission squash-merged to main as 0f0a7bf2a
