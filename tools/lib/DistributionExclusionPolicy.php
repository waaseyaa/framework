...
final class DistributionExclusionPolicy
{
    ...
    private function createArchiveProofTree(string $repo): void
    {
        ...
        foreach ([
            ...
            'config',
            '.claude',
            'packages/foundation/.claude/rules',
        ...
        $files = [
            ...
            '.agents/local' => "local\n",
            '.claude/local' => "local\n",
            'packages/foundation/.claude/rules/canonical.md' => "shipped resource\n",
            'skeleton/.claude/rules/canonical.md' => "shipped template\n",
    ...
    private function verifyArchiveProofEntries(array $entries, string $proof): array
    {
        ...
        foreach ([
            ...
            'composer.json',
            'docs/specs/live.md',
            'packages/foundation/.claude/rules/canonical.md',
            'skeleton/.claude/rules/canonical.md',
            '.env.example',
            'config/.env.example',
        ] as $mustInclude) {
