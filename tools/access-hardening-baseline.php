...
return [
    ...
    'packages/foundation/src/Kernel/EnvLoader.php::$loadedPaths'
        => 'Process-lifetime set of canonical dotenv base paths only; contains no values, secrets, requests, accounts, entities, or decisions, is bounded by the explicitly bootstrapped application roots, and prevents retained workers from reparsing files or repeating process-global mutation per request.',
